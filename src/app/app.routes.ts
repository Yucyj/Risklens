...
export const routes: Routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'risk-map', loadComponent: () => import('./features/risk-map/risk-map').then(m => m.RiskMap) },
      { path: 'contracts', loadComponent: () => import('./features/contracts/contracts').then(m => m.Contracts) },
      { path: 'deal-flow', loadComponent: () => import('./features/deal-flow/deal-flow').then(m => m.DealFlow) },
      { path: 'forecasting', loadComponent: () => import('./features/forecasting/forecasting').then(m => m.Forecasting) },
